...
class _OnBoardState extends State<OnBoard> {
  ...
  List<OnboardModel> screens = <OnboardModel>[
    OnboardModel(
      ...
      text: "One place for fullfilling all your educational needs",
      desc: "Quizzes, Assignments, Announcements and much more on the go!",
      bg: Colors.white,
      button: const Color(0xFF4756DF),
    ),
    OnboardModel(
      img: 'assets/images/img-2.png',
      text: "Connect with your Teachers",
      desc: "A place where you can stay updated with your peers!",
      bg: const Color(0xFF4756DF),
      button: Colors.white,
    ),
    OnboardModel(
      img: 'assets/images/img-3.png',
      text: "Excitements and Curiosity!",
      desc: "Are you ready to embark on a learning journey with us!",
      bg: Colors.white,
      button: const Color(0xFF4756DF),
    ),
  ];
